  ...
  <!-- BEGIN SIDEBAR -->
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="assets/img/profiles/dustin.jpg"  alt="" data-src="assets/img/profiles/dustin.jpg" data-src-retina="assets/img/profiles/dustin.jpg" width="69" height="69" /> </div>
        <div class="user-info">
      ...
      <ul>
        ...
        <li  class="open active" > <a href="javascript:;"> <i class="fa fa fa-adjust"></i> <span class="title">Themes</span> <span class=" open  arrow" ></span> </a>
            <ul class="sub-menu">
      	...
      	<div class="col-md-7">
			<div class="grid simple transparent">
				...
				<div class="grid-body">
                  ...
                  <a class="pull-left" style="padding-right: 10px;" href="#"><img  src="http://placehold.it/200" alt="illustration"></a>
                  <p>is the art and technique of arranging type in order to make language visible.
                    ...
                    <a class="pull-right" href="#" style="padding-left: 10px;"><img  src="http://placehold.it/200" alt="illustration"></a>
                    <p>is the art and technique of arranging type in order to make language visible.
                        The arrangement of type involves the selection of typefaces, point size, line length,
                        leading (line spacing), adjusting the spaces between groups of letters (tracking)
                    </p>
