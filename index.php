<?php
$page = 'home';
include_once('include/header-v2.php')?>
    <!--  BODY PAGE CONTENT -->
    <!-- first section - Home -->
    <div id="home" class="home">
        <div class="text-vcenter">
            <h1>Welcome to <span class="highlight">IMPACT</span></h1>
            <h3>This is some subtitle text</h3>
    ...
    <div id="about" class="pad-section">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="text-vcenter">
                        <img src="assets/img/node-graph.jpg" alt="" />
                    </div>
                </div>
    ...
    <div id="contributors" class="pad-section">
        <div class="container">
            <h2 class="text-center">Contributors</h2> <hr />
    ...
    <!-- /fourth section -->
    <!-- fifth section -->
    <div id="catalog" class="pad-section">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h3>Section placeholder</h3>
                    <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed hendrerit adipiscing blandit.</h4>
                </div>
            </div>
        </div>
    </div>
    <!-- /fifth section -->
<?php include_once('include/footer-v2.php');?>